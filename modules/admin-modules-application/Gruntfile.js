...
//                    '<%= jshint.files %>'
    ...
    var buildTasks = ['clean', 'bower-offline-install', 'sed:imports', 'sass', 'cssmin', 'jshint', 'test'];
    ...
    try {
        ...
        if(pythonPath) {
            ...
            buildTasks = ['clean', 'bower-offline-install', 'sed:imports', 'sass', 'cssmin', 'jshint', 'casper-test', 'test'];
        }
    } catch (e) {
